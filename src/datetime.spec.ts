...
test('lesserOf works when value is null', () => {
    const datetime2 = new Datetime(1746736700);
    expect(datetime2.lesserOf(null)).toEqual(datetime2);
});
...
test('greaterOf works when value is null', () => {
    const datetime2 = new Datetime(1746736700);
    expect(datetime2.greaterOf(null)).toEqual(datetime2);
})
